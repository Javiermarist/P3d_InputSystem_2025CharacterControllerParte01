...
public class PlayerController2 : MonoBehaviour
{
    ...
    void Start()
    {
        animator = GetComponent<Animator>(); // Obtener el componente de animación
...
// Método para calcular el movimiento del jugador basado en la cámara
    private void HandleMovement()
    {
        ...
        animator.SetFloat("walkVelocity", input.magnitude * speed);
...
// Ajuste para la gravedad y el salto
    ...
    public void SlideDown()
    {
        ...
        // Nos dice si hacemos contacto con el suelo 
